...
from typing import List, Tuple, Optional, Callable, Dict, Any, Awaitable
...
# ============ НАСТРОЙКИ ============
TOKEN = "7154351713:AAHhaBNM5AUmYosR3zdFeaZBypSgOL_97AA"  # токен бота

admins_id = [8063185389]

SUBGRAM_TOKEN = "b7dae10fecc75a7a9c1031c5a2a61d8d86f0156abf21647399867adb4205ceb3"  # токен subgram
HIVIEWS_TOKEN = "UA6TXBT1RD0ZRAGRHRY5R"

admin_username = "@Skwlqa"  # свой username
admin_link = "https://t.me/Skwlqa"

GIFT_AMOUNT = 0.5  # ежедневный гифт
DAILY_COOLDOWN = 24 * 60 * 60  # не трогать
DELAY_TIME = 90  # не трогать

# основной канал
channel_osn = "https://t.me/teamraz"
# чат
chater = "https://t.me/piarvbm"
id_chat = -1002768211871
# канал выплат
channel_viplat = "https://t.me/mebld"
channel_viplat_id = -1003498880772
...
def initialize_database():
    ...
    # Добавление столбца registration_time (если отсутствует)
    try:
    ...
    # Создание таблицы promocode_uses
    ...
    try:
        ...
        print('Поле id_channel_private добавлено в таблице "new_tasks"')
    except sqlite3.OperationalError as e:
        if "duplicate column name" in str(e):
